      ...
      {isMobile ? (
        <main className="min-h-screen bg-gray-300 p-4 text-black font-pda text-[15px] tracking-wider">
          ...
          <div className="border border-black bg-gray-100 p-4 rounded">
            ...
            <p><strong>🎥 Streaming Notice:</strong> All work is streamed (courtesy) at <a href="https://picarto.tv/Dewclawpaw" className="underline text-blue-700" target="_blank" rel="noreferrer">Picarto</a>.</p>
        ...
        <main className="min-h-screen relative overflow-hidden flex items-center justify-center p-4 bg-[#f4f1ec]">
          ...
          >
            ...
            <div className="p-6 font-sans text-sm text-gray-800 space-y-6">
              <div>
                <p><strong>Streaming Notice:</strong> All work is done on stream (as a courtesy to clients) via <a href="https://picarto.tv/Dewclawpaw" className="text-blue-600 underline" target="_blank" rel="noreferrer">Picarto</a>.</p>
              </div>
              ...
              <div>
                <p><strong>Billing Policy:</strong> I charge <strong>$30 USD/hour</strong>. The timer only runs while I am actively drawing (idle/tabbed-out time is not counted). Invoices are sent immediately after the sketch is completed.</p>
              </div>

              <div>
                <p><strong>Refund Policy:</strong> I do <span className="underline">not</span> accept refunds once work has begun. Final payment is required upon completion.</p>
              </div>

              <div>
                <p><strong>Ownership &amp; Usage:</strong> You reserve the rights to the artwork you commission from me. However, my art <span className="underline">may not</span> be used in any AI data training or machine learning model, under any circumstances.</p>
              </div>
